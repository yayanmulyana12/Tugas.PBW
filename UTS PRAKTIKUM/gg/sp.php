    ...
    <div class="page-heading header-text">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3>Super People</h3>
                    <span class="breadcrumb"><a href="#">Home</a> > <a href="#">Shop</a> > Super People</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="left-image">
                        <img src="assets/images/sp.jpg" alt="" style="width: 400px; height: auto;" />
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    ...
                    <p>
                        WONDER PEOPLE proudly presents a battle royale shooter that will revolutionize how you think
                        about the genre. In SUPER PEOPLE, take control of a super-soldier, each with their own unique
                        skills, and survive until you are the last one standing.
                    </p>
                    <button type="action" class="btn btn-primary buy-now" data-game="Super People" data-price="44"
                        ...
                        <div class="row">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="description" role="tabpanel"
                                    ...
                                    <p>
                                        Battle Royale on another level. Enjoy faster and more intense battles with SUPER
                                        PEOPLE.

                                        This game is a new form of a Battle Royale Shooter.

                                        SUPER PEOPLE is a Battle Royale Shooter where you play as one of the Super
                                        Soldiers with various skills and compete to become the last man or last trio
                                        standing.

                                        Make your character stronger in various ways as the game progresses.
                                        Class-specific skills and ultimates can be learned and used as your character
                                        levels up.

                                        Experience the thrill and excitement of turning the tide in an instant with
                                        faster means to acquire ultimates. The ever-so-different gameplay for each round
                                        adds another flavor to its unique experience one cannot get from playing other
                                        Battle Royale shooters.

                                        Engagements can occur at any time, anywhere, so the process of planning a route
                                        to get the best equipment can be seen as a strategy and a fun element.
                                    </p>
                                    <br />
                                    <p>
