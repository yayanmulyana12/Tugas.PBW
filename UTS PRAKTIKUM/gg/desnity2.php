    ...
    <div class="page-heading header-text">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3>Destiny 2</h3>
                    <span class="breadcrumb"><a href="#">Home</a> > <a href="#">Shop</a> > Destiny 2</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="left-image">
                        <img src="assets/images/Destiny.jpg" alt="" style="width: 400px; height: auto;" />
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    ...
                    <p>
                        Destiny 2 is an action MMO with a single evolving world that you and your friends can join
                        anytime, anywhere, absolutely free.
                    </p>
                    <button type="action" class="btn btn-primary buy-now" data-game="Destiny 2" data-price="0"
                        ...
                        <div class="row">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="description" role="tabpanel"
                                    ...
                                    <p>
                                        Dive into the world of Destiny 2 to explore the mysteries of the solar system
                                        and experience responsive first-person shooter combat. Unlock powerful elemental
                                        abilities and collect unique gear to customize your Guardian's look and
                                        playstyle. Enjoy Destiny 2’s cinematic story, challenging co-op missions, and a
                                        variety of PvP modes alone or with friends. Download for free today and write
                                        your legend in the stars.
                                    </p>
                                    <br />
                                    <p>
                                ...
                                <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                                    <p>
                                        Posted: 18 May
                                        I'm not sure why people have such a complicated relationship with Destiny 2.
                                        It's literally just play when there's something fun to do and don't when there's
                                        not. Pick up the expansions on sale, you'll realize quickly that compared to
                                        other subscription based games, D2 really isn't as expensive as most people make
                                        it out to be. There really isn't anything like Destiny on the market, it's worth
                                        at least a try.
                                    </p>
                                </div>
                            </div>
