...
<body>
    ...
    <div class="page-heading header-text">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3>Yu-Gi-Oh! MASTER DUEL</h3>
                    <span class="breadcrumb"><a href="#">Home</a> > <a href="#">Shop</a> > Yu-Gi-Oh! MASTER DUEL</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="left-image">
                        <img src="assets/images/yu.jpg" alt="" style="width: 400px; height: auto;" />
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    <h4>Yu-Gi-Oh! MASTER DUEL</h4>
                    <span class="price">$32</span>
                    <p>
                        Yu-Gi-Oh! MASTER DUEL is the ultimate free-to-play cross-platform strategy card game with
                        fast-paced Duels, stunning HD graphics and a new, dynamic soundtrack! Get ready to challenge
                        Duelists around the world!
                    </p>
                    <button type="action" class="btn btn-primary buy-now" data-game="Yu-Gi-Oh MD" data-price="32"
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="description" role="tabpanel"
                                    ...
                                    <p>
                                        ...
                                        Fast-paced Duels with stunning HD graphics and a new, dynamic soundtrack! Get
                                        ready to challenge Duelists around the world!

                                        ◇Play Duels at Any Level!
                                        The full Yu-Gi-Oh! experience is available for anyone at any Skill Level. Don't
                                        worry if you're a new player or if you haven't Dueled in a while, the in-game
                                        tutorials will teach you the basics on how to play the Yu-Gi-Oh! TRADING CARD
                                        GAME. You'll be given a Deck when you finish to help you start your journey!
                                        Collect new cards as you progress through the game to power up your Decks!

                                        ◇Rotating Tournament Formats
                                        Mix it up and put your Dueling skills to the test! A wide variety of events and
                                        tournaments will be available for players.
                                        Build and Duel with different Decks utilizing 10,000+ unique cards and special
                                        rules unique to Tournaments!
                                ...
                                <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                                    <p>
                                        Posted: 5 May
                                        Installed the game and did the tutorial stuff then started a casual match with
                                        the structure deck I started with. I went first and played a couple monsters and
                                        set a face down. I then proceeded to spend 15 minutes watching my opponent do
                                        100 different things until there was 5 monsters on his field, one with over 5000
                                        attack points. I don't know what this game has become but I cannot recommend to
                                        it anyone new or anyone who played it 10+ years ago. Matches lasting 2 turns is
                                        and never even having a chance to attack is completely stupid and un-fun.
                                    </p>
                                </div>
                            </div>
                        </div>
