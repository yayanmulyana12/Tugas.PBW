    ...
    <div class="page-heading header-text">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3>Lost Ark</h3>
                    <span class="breadcrumb"><a href="#">Home</a> > <a href="#">Shop</a> > Lost Ark</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="left-image">
                        <img src="assets/images/lostark.jpg" alt="" style="width: 400px; height: auto;" />
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    <h4>Lost Ark</h4>
                    <span class="price">Pre Order</span>
                    <p>
                        the frozen wastes of Arat Prime are not devoid of intelligent life; on the contrary, the city
                        has become a war-torn battleground between twisted Element-powered 'factions' seeking to undo
                        what was accomplished at the end of ARK Extinction. Together with generations of heroes, you'll
                        unite the past and the future of ARK!
                    </p>
                    <button type="action" class="btn btn-primary buy-now" data-game="Lost Ark" data-price="0"
                        ...
                        <div class="row">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="description" role="tabpanel"
                                    ...
                                    <p>
                                        Confront the demons of Arat Prime -- birthplace of the ARKs -- in ASA's first
                                        massive canonical expansion pack, ARK Lost Colony! Starring Michelle Yeoh as Mei
                                        Yin in cinematic anime sequences by legendary Japanese studio MAPPA, the epic
                                        new story of ARK Lost Colony bridges the gap from ARK Extinction to ARK Genesis
                                        and into the world of ARK 2. As you follow in Mei Yin's footsteps through an
                                        intense journey into the heart of darkness, you'll unlock powerful "Lost"
                                        character ability trees, befriend exotic tames, craft "Cursed" tiers of gear,
