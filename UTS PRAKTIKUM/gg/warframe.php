...
<head>
  ...
  <!-- Additional CSS Files -->
   <!-- Di bagian head, pastikan Anda memiliki: -->
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>WarFrame</h3>
          <span class="breadcrumb"><a href="#">Home</a> > <a href="#">Shop</a> > Warframe</span>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="left-image">
            <img src="assets/images/single-game.jpg" alt="" style="width: 400px; height: auto;" />
          </div>
        </div>
        <div class="col-lg-6 align-self-center">
          ...
          <p>
            Awaken as an unstoppable warrior and battle alongside your friends in this story-driven free-to-play online
            action game.
          </p>
            <button type="action" class="btn btn-primary buy-now" data-game="Warframe" data-price="20"
            ...
            <div class="row">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="description" role="tabpanel"
                  ...
                  <p>
                    Confront warring factions throughout a sprawling interplanetary system as you follow the guidance of
                    the mysterious Lotus and level up your Warframe, build an Arsenal of destructive firepower, and
                    realize your true potential across massive open worlds in this thrilling, genre-defining
                  ...
                  <p>Processor:Intel Core i7 860, Intel Core i5 750, or AMD FX-4100 (SSE 4.2 support required)</p>
                ...
                <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                  <p>
                    Posted: 7 May
                    Warframe is one of the funniest game I have ever played where I consistently have no idea what I'm
                    doing.
                    Something is always exploding, someone is yelling "Tenno!", and I just nod along while starting my
                    47th attempt at farming some rare resource that sounds like alien toothpaste.

                    It's a fantastic third-person shooter with space ninjas, laser bows, flying cats, and a lore deeper
                    than my student life

                    BUT.

                    After the first 100 hours, you realize: this isn't just a shooter. It's not just an MMO.
                    This is a farming simulator in space—with style.
                    Want a new weapon? Farm.
                    Want a new Warframe? Farm.
                    Want to breathe? Farm some oxygen first.
                    10/10 would grind again while questioning my life choices.
                  </p>
                </div>
              </div>
            </div>
