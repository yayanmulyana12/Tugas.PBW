        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <span class="breadcrumb"><a href="#">Home</a> > <a href="#">Shop</a> > PUBG: BATTLEGROUNDS</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="left-image">
                        <img src="assets/images/PUBG.jpg" alt="" style="width: 400px; height: auto;" />
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    ...
                    <p>
                        PUBG: BATTLEGROUNDS, the high-stakes winner-take-all shooter that started the Battle Royale
                        craze, is free-to-play! Drop into diverse maps, loot unique weapons and supplies, and survive in
                        an ever-shrinking zone where every turn could be your last.
                    </p>
                    <button type="action" class="btn btn-primary buy-now" data-game="PUBG: BATTLEGROUNDS" data-price="25"
                        ...
                        <div class="row">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="description" role="tabpanel"
                                    ...
                                    <p>
                                        Drop into an ever-growing and changing selection of maps to keep you challenged.
                                        Will you choose the safer outskirts and risk not getting enough loot or hot drop
                                        into the dense cities and fight from the moment you hit the ground? Every drop
                                        is different, it's up to you to make the best with what you find.
                                    </p>
                                    <br />
                                    <p>
                                ...
                                <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                                    <p>
                                        Posted: 8 May Its 2025, game is full of cheaters. And when you report somebody
                                        who obviously used aimhack or wallhack he gets temporerly banned for one hour.
                                        And then he will be back in the game. Really developers? Game is unplayable at
                                        this point.
                                    </p>
                                </div>
                            </div>
